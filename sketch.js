...
function detectCollision(lbasketball,lstar){
	/*var collision = Matter.SAT.collides(lstone,lmango);
	if(collision.collided){
		console.log("collided");
		Matter.Body.setStatic(lmango,false);	
	}*/
  starBodyPosition=lstar.body.position
  basketballBodyPosition=lbasketball.body.position
  
  var distance=dist(basketballBodyPosition.x, basketballBodyPosition.y, starBodyPosition.x, starBodyPosition.y)
  //console.log(distance)
 // console.log(lmango.r+lstone.r)
  	if(distance<=lstar.r+lbasketball.r)
    {
      //console.log(distance);
